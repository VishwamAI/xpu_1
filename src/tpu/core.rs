...
impl TPU {
    ...
    fn calculate_execution_time(&self, task: &Task) -> Duration {
        ...
        base_time.mul_f64(1.0 / self.processing_unit.processing_power)
    }

    fn adjust_power_state(&mut self) {
        self.processing_unit.power_state = match self.processing_unit.current_load.as_secs_f64() / self.processing_unit.processing_power {
